...
{
    use HasPublicUuid;
    protected $fillable = ['organization_id','access_plan_id','network_device_id','assigned_user_id','reference','quantity','retail_price_kobo','pin_length','status','printed_at'];
