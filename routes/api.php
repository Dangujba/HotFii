...
use App\Http\Controllers\Api\MobileDeviceSessionController;
...
use App\Http\Controllers\Api\MobileOrganizationSettingsController;
...
Route::prefix('v1')->name('api.v1.')->group(function () {
    Route::prefix('mobile')->name('mobile.')->group(function () {
        ...
        Route::middleware(['auth:sanctum', 'abilities:mobile'])->group(function () {
            ...
            Route::get('/auth/sessions', [MobileDeviceSessionController::class, 'index'])->name('auth.sessions.index');
            Route::delete('/auth/sessions/{session}', [MobileDeviceSessionController::class, 'destroy'])->name('auth.sessions.destroy');
            ...
            Route::prefix('/organizations/{organization}')
                ...
                ->group(function () {
                    ...
                    Route::get('/settings', [MobileOrganizationSettingsController::class, 'show'])->name('settings.show');
                    Route::patch('/settings', [MobileOrganizationSettingsController::class, 'update'])->name('settings.update');
                    Route::post('/settings/payment-profile', [MobileOrganizationSettingsController::class, 'submitPaymentProfile'])->name('settings.payment-profile');
                    Route::get('/team', [MobileTeamController::class, 'index'])->name('team.index');
                    Route::post('/team', [MobileTeamController::class, 'store'])->name('team.store');
                    Route::patch('/team/{member}', [MobileTeamController::class, 'update'])->name('team.update');
