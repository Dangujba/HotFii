...
.header { border-bottom: 2px solid #f4610a; margin-bottom: 12px; padding-bottom: 8px; }
...
.brand { color: #f4610a; font-size: 16px; font-weight: bold; } .code { font-family: monospace; font-size: 15px; font-weight: bold; letter-spacing: 1px; margin: 8px 0; }
