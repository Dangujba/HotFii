...
@section('actions')<a class="btn btn-hotfii" href="{{ route('reports.export.pdf', request()->only('from','to')) }}" download><i class="bi bi-file-earmark-pdf me-1"></i>Export PDF</a> <a class="btn btn-outline-secondary" href="{{ route('reports.export', request()->only('from','to')) }}" download><i class="bi bi-filetype-csv me-1"></i>Export CSV</a>@endsection
@section('content')
