...
@if($voucher && $voucher->credential)
    ...
    <div class="row g-2 text-start my-4">
        ...
        @if(
            ...
            <div class="col-6">
                <div class="p-3 rounded bg-body-tertiary">
                    ...
                    <strong>
                        {{ \Carbon\CarbonInterval::seconds((int) $allowance['remaining_seconds'])->cascade()->forHumans(['short' => true, 'parts' => 3]) }}
                    </strong>
        ...
        <div class="col-6">
            <div class="p-3 rounded bg-body-tertiary">
                ...
                <strong>
                    {{
                        $voucher->expires_at?->copy()->setTimezone($device->organization->timezone ?: config('app.timezone'))->format('d M Y, H:i T')
                        ?? 'Plan allowance used'
                    }}
                </strong>
    ...
    @elseif(
        $device->vendor ===
            \App\Domain\Enums\RouterVendor::Openwrt
        && ($portalContext['challenge'] ?? null)
    )
        ...
        @if(! $openwrtLogon)
            ...
            <div class="alert alert-warning text-start">
                ...
                <strong>
                    OpenWrt captive portal information is invalid or incomplete.
                </strong>

                <div class="small mt-2">
                    Disconnect from the HotFii guest network,
                    reconnect and open the captive portal again.
                    HotFii will not send credentials to an
                    untrusted CoovaChilli endpoint.
                </div>
        ...
        @else
            ...
            <div class="small text-secondary mt-3">
                ...
                HotFii generated a one-time CoovaChilli
                authentication response for this router and session.
